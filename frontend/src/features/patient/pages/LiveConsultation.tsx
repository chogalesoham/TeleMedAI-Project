...
export const LiveConsultation = () => {
    ...
    return new Promise<void>((resolve) => {
      ...
      mediaRecorderRef.current.onstop = async () => {
        try {
          ...
          // Fetch patient data
          console.log('📥 Fetching patient health data...');
          const patientResponse = await PatientService.getPatientProfile();
          ...
          const patientData = {
            basicHealthProfile: patientResponse.data.onboardingData?.basicHealthProfile || {},
            medicalHistory: patientResponse.data.onboardingData?.medicalHistory || {},
            currentHealthStatus: patientResponse.data.onboardingData?.currentHealthStatus || {},
          };
          ...
          if (result.success) {
            ...
            if (saveResponse.success) {
              ...
              // Redirect to consultation summary page with saved ID
              navigate(`/patient-dashboard/consultation-summary?consultationId=${consultationId}`);
            } else {
              ...
              // Still redirect but maybe with a warning state?
              navigate(`/patient-dashboard/consultation-summary?consultationId=${consultationId}`, {
                state: {
  ...
  const doctor = {
    name: appointment?.doctor.name || 'Dr. Sarah Johnson',
    specialization: 'Cardiologist',
    image: appointment?.doctor.profilePicture || '/doctors/sarah.jpg'
  };
          ...
          <Card className="shadow-2xl border-0 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 p-6 text-white">
              ...
              <p className="text-center text-white/90 text-xs">
                Enter your meeting code to start your video consultation
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 text-base font-mono tracking-wider border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all outline-none uppercase"
                      maxLength={20}
                      onChange={(e) => {
                        const code = e.target.value.trim();
                        if (code) {
                          navigate(`/patient-dashboard/live-consultation?consultationId=${code}`);
                        }
                      }}
                      onKeyPress={(e) => {
                        if (e.key === 'Enter') {
                  ...
                  <p className="mt-1.5 text-xs text-gray-500">
                    Find your code in appointment details
                  </p>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
                  <h3 className="text-xs font-semibold text-blue-900 mb-1.5 flex items-center gap-1.5">
                    ...
                    How to find your meeting code
                  </h3>
                  <ul className="text-xs text-blue-800 space-y-1">
                    <li className="flex items-start gap-1.5">
                      <span className="text-blue-600 font-bold">1.</span>
                      <span>Go to your appointments page</span>
                    </li>
                    <li className="flex items-start gap-1.5">
                      <span className="text-blue-600 font-bold">2.</span>
                      <span>Find your confirmed appointment</span>
                    </li>
                    <li className="flex items-start gap-1.5">
        ...
        <Card className="max-w-md w-full shadow-xl">
          <CardContent className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-4">
              This appointment has not been approved by the doctor yet.
              Please wait for approval before joining the consultation.
            </p>
            ...
            <Button onClick={() => navigate('/patient-dashboard/my-appointments')}>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
          <Card className="max-w-md w-full mx-4">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-4">
                Our AI is transcribing the consultation and generating your summary.
              </p>
            ...
            {remoteStream ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-800 to-gray-900">
                <div className="text-center px-4">
                  ...
                  <p className="text-gray-400 text-xs sm:text-sm mt-2">Waiting for doctor to join...</p>
                </div>
              </div>
            )}

            {/* Local Video Stream (Patient - Picture in Picture) */}
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
