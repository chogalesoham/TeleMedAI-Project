  ...
  return (
    <div className="mx-auto space-y-6">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600">Please wait while we connect you with your doctor</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
          ...
          <Card className="bg-gradient-to-br from-primary/5 to-blue-50 border-primary/20">
            <CardContent className="p-8 text-center">
              ...
              >
                ...
                <h2 className="text-5xl font-bold text-gray-900 mb-2">{formatTime(timeRemaining)}</h2>
                <p className="text-gray-600 mb-4">Estimated wait time</p>
                <Progress value={progress} className="h-2 mb-2" />
                <p className="text-sm text-gray-500">Consultation will start automatically</p>
              </motion.div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Your Position in Queue</h3>
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-gray-600">in line</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-8">
              <div className="flex flex-col items-center justify-center min-h-[300px]">
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="w-48 h-48 rounded-full bg-gradient-to-br from-primary/20 to-blue-200 flex items-center justify-center">
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-2">Tips for a Better Consultation</h3>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold mb-4">Your Doctor</h3>
