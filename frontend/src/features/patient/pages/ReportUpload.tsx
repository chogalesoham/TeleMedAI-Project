  ...
  return (
    <div className="mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600">Upload and manage your medical documents with AI-powered OCR</p>
      </div>
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="p-6">
              <h3 className="font-semibold text-gray-900 mb-4">Upload Statistics</h3>
              <div className="space-y-3">
          ...
          <Card className="bg-blue-50 border-blue-200">
            <CardContent className="p-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold text-blue-900 mb-2">AI-Powered OCR</h3>
