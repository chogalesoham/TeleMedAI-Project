...
import { DoctorConsultationSummary } from "@/features/doctor/pages/DoctorConsultationSummary";
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/doctor-dashboard" element={
            ...
            <Route path="consultation-summary" element={<DoctorConsultationSummary />} />
